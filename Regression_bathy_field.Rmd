...
Acoustic.readings0_5<-split0_5$Depth
EOMAP.Landsat.Depth0_5 <- split0_5$SDB_15m
EOMAP.Sentinel.Depth0_5 <- split0_5$SDB_10m
...
fit3 <-lm(EOMAP.Landsat.Depth0_5 ~ Acoustic.readings0_5 )
fit4 <-lm(EOMAP.Sentinel.Depth0_5 ~ Acoustic.readings0_5 )
